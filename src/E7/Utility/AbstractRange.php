...
/**
 * An abstract baseclass for all kinds of ranges
 */
abstract class AbstractRange implements RangeInterface
{
    ...
    {
        return $this->modifyValue($this->getFrom(), self::MODIFIER_LOWER);
    }
    ...
    {
        return $this->modifyValue($this->getTo(), self::MODIFIER_HIGHER);
    }
    ...
    /**
     * Check if the given instance in equal
     * 
     * @param   object $object
     * @return  boolean
     */
